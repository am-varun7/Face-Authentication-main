    ...
    <div className="auth-card">
        <div className="auth-card-body">
            <div className="video-container">
                <video ref={videoRef} width="100%" height="auto" autoPlay muted className="auth-video" />
            </div>
            <div className="auth-buttons">
                <button onClick={startAuthentication} disabled={isAuthenticating} className="auth-btn auth-btn-success">
                    Start Authentication
                </button>
                <button onClick={stopAuthentication} disabled={!isAuthenticating} className="auth-btn auth-btn-danger">
                    Stop Authentication
                </button>
            </div>
            <h3 className="auth-identified-name mt-3">{identifiedPerson ? `Identified: ${identifiedPerson}` : ""}</h3>
